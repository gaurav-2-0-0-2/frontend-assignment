                ...
                {jsonObject.map((item, index) => {
                    return (
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div key={index} className='p-10 bg-blue-500 rounded-xl my-4'>

                                    <h1 className='text-2xl'>New Pizza</h1>
                                    {index === 0 ? (
                                        <div className='flex flex-row gap-5 justify-between mt-10'>
                                            <h1>{item.label}</h1>
                                            <input className='outline-none px-2 rounded-md w-[30rem] h-[3rem]' name='pizza_name' onChange={(e) => setFormData(e.target.value)} placeholder={item.placeholder} type="text" />
                                        </div>
                                    ) : index === 1 ? (
                                        <div>
                                            <h1>{item.label}</h1>
                                            ...
                                            <div className='flex justify-between mt-5'>
                                                ...
                                                <select className='w-[30rem] h-[3rem] rounded-md'>
